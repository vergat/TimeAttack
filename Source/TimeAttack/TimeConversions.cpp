...
{
	int32 minutes = FMath::Floor(time / 60.0f);
	int32 seconds = FMath::Floor(FMath::Fmod( time,60.0f));
	int32 milliseconds=FMath::Floor(time);
	milliseconds= FMath::Floor((time-milliseconds)*100.0f);
